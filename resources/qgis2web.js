...
map.getView().fit([-7960107.494205, -3911255.795416, -7946810.715191, -3902328.047253], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Clasificación de manzanas de Quilpue en base a su temperatura - Verano 2024</h2>';
        return titleElement;
    })(),
